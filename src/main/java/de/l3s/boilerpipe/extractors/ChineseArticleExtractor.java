 ...
 */
public final class ChineseArticleExtractor extends ExtractorBase {
    public static final ChineseArticleExtractor INSTANCE = new ChineseArticleExtractor();

    /**
     * Returns the singleton instance for {@link de.l3s.boilerpipe.extractors.ChineseArticleExtractor}.
     */
